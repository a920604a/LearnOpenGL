...
int main()
{
    ...
    // -------------------------
    Shader shader("src/4.advanced_opengl/5.2.framebuffers_exercise1/5.2.framebuffers.vs", "src/4.advanced_opengl/5.2.framebuffers_exercise1/5.2.framebuffers.fs");
    Shader screenShader("src/4.advanced_opengl/5.2.framebuffers_exercise1/5.2.framebuffers_screen.vs", "src/4.advanced_opengl/5.2.framebuffers_exercise1/5.2.framebuffers_screen.fs");
