...
int main()
{
    ...
    // -------------------------
    Shader shader("src/5.advanced_lighting/5.3.parallax_occlusion_mapping/5.3.parallax_mapping.vs", "src/5.advanced_lighting/5.3.parallax_occlusion_mapping/5.3.parallax_mapping.fs");
