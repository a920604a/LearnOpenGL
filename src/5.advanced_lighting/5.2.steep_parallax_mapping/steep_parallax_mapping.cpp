...
int main()
{
    ...
    // -------------------------
    Shader shader("src/5.advanced_lighting/5.2.steep_parallax_mapping/5.2.parallax_mapping.vs", "src/5.advanced_lighting/5.2.steep_parallax_mapping/5.2.parallax_mapping.fs");
