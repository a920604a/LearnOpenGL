...
int main()
{
    ...
    // -------------------------
    Shader shader("src/5.advanced_lighting/5.1.parallax_mapping/5.1.parallax_mapping.vs", "src/5.advanced_lighting/5.1.parallax_mapping/5.1.parallax_mapping.fs");
